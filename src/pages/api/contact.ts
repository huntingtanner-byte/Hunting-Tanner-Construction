...
<style>
  ...
  .card { max-width:34rem; background:#fff; border:1px solid #c9d3da;
  ...
  a.btn { display:inline-block; background:#546a7b; color:#fff; text-decoration:none;
    font-weight:600; padding:.75rem 1.5rem; border-radius:10px; margin-top:.5rem; }
  a.plain { color:#546a7b; }
  p { margin:0 0 1rem; }
</style>
</head>
<body>
